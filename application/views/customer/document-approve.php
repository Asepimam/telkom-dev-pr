...
<script>
    // Pindahkan pembuatan QR code di luar fungsi show.bs.modal
    $(document).ready(function() {
        // Inisialisasi QR code di luar fungsi
        var qrcode;
        ...
        $('#exampleModal').on('show.bs.modal', function(event) {
            ...
            // Cek apakah QR code sudah dibuat
            if (!qrcode) {
                // Jika belum, buat QR code menggunakan library qrcode.js
