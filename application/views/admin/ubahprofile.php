...
<div class="container-fluid">
    <div class="form-row">
        <div class="col-lg-9">
            <form method="post" action="<?= base_url('admin/ubahprofile/update_profile'); ?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="row">
                            <div class="col-sm-3">
                                <img src="<?= base_url('assets/img/profile/') . $user->Image; ?>" class="img-thumbnail" alt="Profil Gambar">
                            </div>
                            <div class="col-sm-9">
                ...
                <div class="form-group justify-content-end ">
                    ...
                    <div class="col-sm-10">
                        ...
                        <button class="btn btn-dark">
                            <a href="<?= base_url('admin/profile'); ?>" class="text text-white">Kembali</a>
                        </button>
                    </div>
                </div>
            </form>
