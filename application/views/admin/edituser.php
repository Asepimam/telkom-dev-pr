<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="<?php echo base_url() ?>admin/editusers/editUser/<?php echo $user->ID ?>">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="role" name="role">
                                    ...
                                    <?php foreach ($roles as $role) { ?>
                                        <option value="<?php echo $role->ID_Role ?>"><?php echo $role->Nama_Role ?> <?php echo $role->ID_Role ?> </option>
                                    <?php } ?>
                                </select>
                            </div>
